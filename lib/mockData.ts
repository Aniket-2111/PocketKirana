...
export const INITIAL_BRANDS: Brand[] = [
  ...
  },
  {
    ...
    logoUrl: '/brands/mother-dairy.svg',
    bannerUrl: 'https://images.unsplash.com/photo-1527153857715-3908f2ae5e81?auto=format&fit=crop&w=1200&q=80',
  ...
  },
  {
    ...
    name: 'Surf Excel',
    slug: 'surf-excel',
    logo: '/brands/surf-excel.svg',
    logoUrl: '/brands/surf-excel.svg',
  ...
  },
  {
    ...
    logoUrl: '/brands/nestle.svg',
    bannerUrl: 'https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=1200&q=80',
    description: 'Maggi noodles, Nescafe coffee, KitKat and Everyday dairy whitener.',
    isActive: true,
    status: 'active',
    displayOrder: 11,
    categoryIds: ['cat-snacks', 'cat-drinks', 'cat-dairy'],
    productCount: 1,
  },
  {
    id: 'brand-parle',
    ...
    logoUrl: '/brands/parle.svg',
    bannerUrl: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=1200&q=80',
    description: 'Parle-G, Monaco, Krackjack and Hide & Seek chocolate chip cookies.',
    isActive: true,
    status: 'active',
    displayOrder: 12,
    categoryIds: ['cat-bakery', 'cat-snacks'],
    productCount: 1,
  },
  {
    id: 'brand-everest',
    name: 'Everest',
    slug: 'everest',
    logo: '/brands/everest.svg',
    logoUrl: '/brands/everest.svg',
    bannerUrl: 'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=1200&q=80',
    description: 'Everest pure and blended spice powders, garam masala and culinary seasonings.',
    isActive: true,
    status: 'active',
    displayOrder: 13,
    categoryIds: ['cat-staples'],
