...
export const INITIAL_ORDERS: Order[] = [
  ...
  },
  {
    ...
    paymentStatus: 'completed',
    orderStatus: 'delivered',
    placedAt: new Date(Date.now() - 3 * 24 * 3600 * 1000).toISOString(),
    deliverySlot: 'Delivered',
    deliveryOtp: '5678',
    partnerId: 'partner-1',
    partnerName: 'Sunil Kumar',
    ...
    items: [
      ...
      },
      {
        id: 'oi-21',
        orderId: 'PK102750',
        productId: 'p-banana-robusta-1kg',
  ...
  },
  {
    ...
    paymentStatus: 'completed',
    orderStatus: 'delivered',
    placedAt: new Date(Date.now() - 7 * 24 * 3600 * 1000).toISOString(),
    deliverySlot: 'Delivered',
    deliveryOtp: '9921',
    partnerId: 'partner-1',
    partnerName: 'Sunil Kumar',
    ...
    items: [
      {
        id: 'oi-30',
        orderId: 'PK102600',
        productId: 'p-fortune-sunflower-1l',
