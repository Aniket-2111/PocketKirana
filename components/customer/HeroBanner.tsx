...
export const HeroBanner: React.FC = () => {
  ...
  return (
    <div className="relative w-full rounded-2xl sm:rounded-3xl overflow-hidden shadow-xs border border-amber-200/60 bg-gradient-to-r from-[#FFFDF5] via-[#FFF8E7] to-[#EBF6EE] group min-h-[220px] sm:min-h-[280px] md:min-h-[320px] flex items-center">
      ...
      <div className="absolute bottom-0 left-1/4 w-48 sm:w-64 h-48 sm:h-64 bg-amber-200/30 rounded-full blur-xl pointer-events-none" />
      ...
      <div className="relative z-10 w-full p-4 sm:p-8 md:p-10 flex flex-col-reverse sm:flex-row items-center justify-between gap-4 sm:gap-6">
        ...
        <div className="space-y-2.5 sm:space-y-3.5 max-w-xl text-center sm:text-left">
          ...
          <div className="inline-flex items-center gap-1.5 bg-white/90 border border-[#0B8F5A]/30 text-[#075C3C] px-3 py-1 rounded-full text-[10px] sm:text-xs font-black shadow-2xs">
          ...
          {/* Heading */}
          <h1 className="text-xl sm:text-3xl md:text-4xl font-black text-[#075C3C] tracking-tight leading-tight">
            {current.title || 'Quality & Freshness Guaranteed!'}
          </h1>

          {/* Subtitle */}
          <p className="text-[11px] sm:text-xs md:text-sm font-medium text-slate-700 max-w-md line-clamp-2 leading-relaxed">
            {current.subtitle ||
          ...
          <div className="pt-1 flex flex-wrap items-center justify-center sm:justify-start gap-2.5 sm:gap-3">
            ...
            <div className="hidden md:flex items-center gap-2 text-xs font-extrabold text-[#075C3C] bg-white/80 px-3.5 py-2.5 rounded-2xl border border-emerald-200/80 shadow-2xs">
              <CheckCircle2 className="w-3.5 h-3.5 text-[#0B8F5A]" />
        ...
        <div className="w-40 sm:w-60 md:w-80 h-32 sm:h-48 md:h-60 relative shrink-0 flex items-center justify-center">
          <div className="relative w-full h-full rounded-2xl sm:rounded-3xl overflow-hidden border-2 sm:border-4 border-white shadow-lg bg-white group-hover:scale-102 transition-transform duration-500">
            <img
