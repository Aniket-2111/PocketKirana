  ...
  return (
    <div className="relative group/carousel my-4">
      ...
      <button
        ...
        onClick={() => scroll('left')}
        className="hidden md:flex absolute -left-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-[#0B8F5A] text-white shadow-md items-center justify-center transition-all hover:scale-110 active:scale-95 cursor-pointer opacity-90 hover:opacity-100"
        title="Scroll Left"
      >
      ...
      <button
        ...
        className="hidden md:flex absolute -right-2 top-1/2 -translate-y-1/2 z-20 w-8 h-8 rounded-full bg-[#0B8F5A] text-white shadow-md items-center justify-center transition-all hover:scale-110 active:scale-95 cursor-pointer opacity-90 hover:opacity-100"
        title="Scroll Right"
      >
