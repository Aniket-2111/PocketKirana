...
function AdminDashboardContent() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F5F7] text-slate-900 flex flex-col font-sans" suppressHydrationWarning>
      ...
      {/* ── PROFESSIONAL TWO-COLUMN SPLIT SCREEN PRODUCT EDITOR MODAL ── */}
      <ProductEditorModal
        ...
        onSave={(newProductData) => {
          ...
          setShowAddProductModal(false);
          showToast(`${newProductData.name || 'Product'} added to catalog!`, 'success');
        }}
      />
      ...
      <ProductEditorModal
        ...
        onSave={(updatedData) => {
          if (editingProduct) {
            ...
            setEditingProduct(null);
            showToast(`${updatedData.name || 'Product'} updated successfully!`, 'success');
          }
        }}
      />
      {/* ── MODAL: ADD CATEGORY ── */}
